...
export default function MobileSalarySlip() {
  ...
  const pdfRef = useRef();
  useEffect(() => {
    // Simple animation for underline
  ...
  const handleDownloadPdf = () => {
    try {
      ...
      pdf.text("Salary Payslip", pdfWidth / 2, titleTopMargin, {
        align: "center",
      });
      ...
      pdf.text(
        "PaySlip for the Month of September 2025",
        pdfWidth / 2,
        monthLineY,
        { align: "center" }
      );
      ...
      // Headers
      pdf.text("EARNINGS", 20 + col1Width / 2, tableStartY + 5, {
        align: "center",
      });
      pdf.text("AMOUNT", 20 + col1Width + col1Width / 2, tableStartY + 5, {
        align: "center",
      });
      pdf.text(
        "DEDUCTIONS",
        20 + col1Width * 2 + col1Width / 2,
        tableStartY + 5,
        { align: "center" }
      );
      pdf.text("AMOUNT", 20 + col1Width * 3 + col1Width / 2, tableStartY + 5, {
        align: "center",
      });
      ...
      pdf.setFontSize(10);
      pdf.setFont("helvetica", "bold");
      pdf.text("REIMBURSEMENTS", 20 + col1Width / 2, reimbRowY + 5.5, {
        align: "center",
      });
      pdf.text("AMOUNT", 20 + col1Width + col1Width / 2, reimbRowY + 5.5, {
        align: "center",
      });
      pdf.text("", 20 + col1Width * 2 + col1Width / 2, reimbRowY + 5.5, {
        align: "center",
      });
      pdf.text("", 20 + col1Width * 3 + col1Width / 2, reimbRowY + 5.5, {
        align: "center",
      });
      ...
      pdf.line(
        ...
        reimbRowY + rowHeight,
        20 + col1Width,
        reimbRowY + rowHeight + reimbTableHeight
      );
      ...
      for (let i = 1; i < reimbTableRows; i++) {
        pdf.line(
          20,
          reimbRowY + rowHeight + i * rowHeight,
          20 + col1Width * 2,
          reimbRowY + rowHeight + i * rowHeight
        );
      }
      ...
      pdf.setTextColor(255, 255, 255); // White text
      pdf.text(
        "TOTAL NET PAYABLE: " + formatCurrency("50,313.95"),
        pdfWidth / 2,
        netPayableY + 7,
        { align: "center" }
      );
      ...
      pdf.text(
        "(Fifty Thousand Three Hundred and Thirteen Rupees & 95/100)",
        pdfWidth / 2,
        netPayableY + 14,
        { align: "center" }
      );
      ...
      <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="text-right mb-4 p-4">
          <button
            ...
            className="bg-[#058CBF] hover:bg-[#81c9e4] text-white font-bold cursor-pointer py-2 px-4 rounded text-sm sm:text-base"
          >
            Download PDF
          </button>
        </div>
        ...
        <div
          ref={pdfRef}
          className="max-w-4xl mx-auto p-8 bg-white shadow-lg border rounded-lg mt-10 font-sans text-sm"
        >
          <div className="mb-6">
            <h2 className="text-center font-semibold text-gray-800 text-xl sm:text-2xl mb-6">
              <span className="relative inline-block">
                Salary Payslip
                <span
                  ref={underlineRef}
                  className="absolute left-0 bottom-0 h-[2px] bg-[#018ABE] transition-all duration-1000 ease-out"
                  style={{ width: "0%" }}
                ></span>
              </span>
            </h2>
            <div className="mt-2 text-center sm:text-left">
              ...
              <p>Kurla, Mumbai</p>
              <p className="text-xs sm:text-sm">iscr.orgin.com | 8976104646</p>
            </div>
          </div>
          ...
          <div className="overflow-x-auto">
            ...
            <div className="hidden md:block">
              ...
              <div className="border-x border-b border-gray-300">
                <div className="grid grid-cols-4 text-sm border-b border-gray-300">
                  <div className="px-4 py-2 border-r border-gray-300 text-left">
                    Basic Salary
                  </div>
            ...
            <div className="md:hidden space-y-4">
              ...
              <div className="bg-white border border-gray-300 rounded-lg overflow-hidden">
                <div className="bg-[#018ABE] text-white text-center font-semibold py-3">
                  <h3 className="text-lg">EARNINGS</h3>
                </div>
                <div className="divide-y divide-gray-200">
                  <div className="flex justify-between px-4 py-3">
                    <span className="text-left">Basic Salary</span>
                    <span className="font-medium">Rs. 50,600.00</span>
                  </div>
                  <div className="flex justify-between px-4 py-3">
                    <span className="text-left">House Rent Allowance</span>
                    <span className="font-medium">Rs. 200.00</span>
                  </div>
                  <div className="flex justify-between px-4 py-3">
                    <span className="text-left">Conveyance</span>
                    <span className="font-medium">Rs. 150.00</span>
                  </div>
                  <div className="flex justify-between px-4 py-3">
                    <span className="text-left">Medical</span>
                    <span className="font-medium">Rs. 150.00</span>
                  </div>
                  <div className="flex justify-between px-4 py-3">
                    <span className="text-left">Special Allowance</span>
                  ...
                  <div className="flex justify-between px-4 py-3 bg-[#018ABE] text-white font-bold">
                    <span>Gross Salary</span>
                    <span>Rs. 51,410.00</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-300 rounded-lg overflow-hidden">
                ...
                <div className="divide-y divide-gray-200">
                  <div className="flex justify-between px-4 py-3">
                    <span className="text-left">EPF</span>
                    <span className="font-medium">Rs. 800.00</span>
                  </div>
                  <div className="flex justify-between px-4 py-3">
                    <span className="text-left">Health Insurance</span>
                    <span className="font-medium">Rs. 356.36</span>
                  </div>
                  <div className="flex justify-between px-4 py-3">
                    <span className="text-left">Professional Tax</span>
                    <span className="font-medium">Rs. 62.55</span>
                  </div>
                  <div className="flex justify-between px-4 py-3">
                    <span className="text-left">TDS</span>
                    <span className="font-medium">Rs. 0.00</span>
                  </div>
                  <div className="flex justify-between px-4 py-3 bg-[#018ABE] text-white font-bold">
                    <span>Total Deductions</span>
                    <span>Rs. 1,218.55</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6">
            <div className="bg-[#018ABE] text-white font-semibold text-center py-3 rounded-t-lg md:rounded-none md:grid md:grid-cols-4">
              <div className="md:px-4">REIMBURSEMENTS</div>
              <div className="md:px-4 hidden md:block">AMOUNT</div>
              <div className="hidden md:block"></div>
              <div className="hidden md:block"></div>
            </div>

            <div className="border border-gray-300 border-t-0 md:border-t rounded-b-lg md:rounded-none">
              {/* Desktop Reimbursements */}
              <div className="hidden md:block">
                ...
                <div className="grid grid-cols-2 text-sm">
                  <div className="px-4 py-2 border-r border-gray-300 font-semibold text-left">
              ...
              <div className="md:hidden divide-y divide-gray-200">
                <div className="flex justify-between px-4 py-3">
                  <span className="text-left">Mobile Bill</span>
                  <span className="font-medium">Rs. 50.00</span>
                </div>
                <div className="flex justify-between px-4 py-3">
                  <span className="text-left">Travel</span>
                  <span className="font-medium">Rs. 30.00</span>
                </div>
                <div className="flex justify-between px-4 py-3">
                  <span className="text-left">Food</span>
                  <span className="font-medium">Rs. 20.00</span>
                </div>
          ...
          <div className="bg-[#018ABE] text-white mt-6 p-4 rounded-lg text-center">
            <p className="text-lg sm:text-xl font-bold">
              TOTAL NET PAYABLE: Rs. 50,313.95
            </p>

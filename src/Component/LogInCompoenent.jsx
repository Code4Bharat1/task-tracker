...
const LoginComponent = ({ 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If onLogin prop is provided, use it (for custom authentication)
      if (onLogin) {
        await onLogin(formData);
      } else {
        // Default API call to your login route
        ...
        // Successful login - redirect or call success callback
        console.log('Authentication successful:', data);
        
        // Redirect to chat or specified URL

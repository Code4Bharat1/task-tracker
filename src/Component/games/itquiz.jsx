...
export default function TechQuizApp() {
    ...
    }, [timeRemaining, showResult, quizStarted]);
    ...
    if (!quizStarted) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center py-4">
                <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center border border-gray-100">
                    ...
                    <p className="text-gray-600 mb-8">Answer 10 questions in 3 minutes! Complete early to record your time.</p>

                    <div className="grid grid-cols-3 gap-4 mb-8">
                        <div className="text-center p-3 bg-blue-50 rounded-lg">
                            <div className="text-2xl font-bold text-[#018ABE]">10</div>
                        ...
                        <div className="text-center p-3 bg-purple-50 rounded-lg">
                            ...
                            <div className="text-xs text-gray-600">Point Each</div>
                        </div>
                    </div>
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                    ...
                    {showAnswerFeedback && (
                        ...
                        >
                            {currentIndex + 1 < questions.length ? 'Next Question' : 'Finish Quiz'} <ArrowRight className="w-5 h-5" />
                        </button>
                    )}
                </div>
